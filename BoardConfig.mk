...
API_MAKE := \
	...
	ARCH=arm \
	CROSS_COMPILE=$(ANDROID_BUILD_TOP)/prebuilt/$(HOST_PREBUILT_TAG)/toolchain/arm-eabi-4.6.2-linaro/bin/arm-eabi- \
	HOST_PLATFORM=zoom2 \
...
TARGET_KERNEL_CUSTOM_TOOLCHAIN := arm-eabi-4.6.2-linaro
